...
exports.workExperiences = exports.calculateSizes = exports.myProjects = exports.clientReviews = exports.navLinks = void 0;
exports.navLinks = [
    {
        id: 1,
        name: 'Home',
...
exports.clientReviews = [
    {
        id: 1,
        name: 'Charles Inwald',
        position: 'Full-Stack Developer at Trude',
        img: 'assets/review1.jpg',
        review: 'Working with Dario on MintBill was a fantastic experience. His attention to detail and commitment to quality are unmatched. Highly recommend him for any web dev project.',
    },
    {
        id: 2,
        ...
        review: 'Dario’s expertise in web development is truly impressive. He delivered a robust and scalable solution for my e-commerce site, and my online sales have significantly increased since the launch. He’s a true professional! Fantastic work.',
    },
];
exports.myProjects = [
    {
    ...
    {
        title: 'DebateSolutions - Real-Time Social Media Platform',
        desc: 'DebateSolutions is a powerful collaborative app that elevates the capabilities of real-time interpersonal digital interaction. A cutting-edge collaborative platform designed for high-stakes, real-time digital discussions. Think of it as Google Docs on steroids—built to handle millions of simultaneous contributors with precision and zero lag.',
...
var calculateSizes = function (isSmall, isMobile, isTablet) {
    return {
